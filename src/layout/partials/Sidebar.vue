  ...
  <section class="app-sidebar">
    <nav class="sidebar sidebar-offcanvas" id="sidebar">
      <ul class="nav">
        ...
        <li class="nav-item">
          <span class="nav-link" v-b-toggle="'marcas'">
            <span class="menu-title">Marcas</span>
            <i class="menu-arrow"></i>
            <i class="mdi mdi-crosshairs-gps menu-icon"></i>
          </span>
          <b-collapse accordion="sidebar-accordion" id="marcas">
            <ul class="nav flex-column sub-menu">
              <li class="nav-item">
                <router-link class="nav-link" to="/marcas/registrar/">Crear</router-link>
              </li>
              <li class="nav-item">
                <router-link class="nav-link" to="/marcas/listar/">Listar</router-link>
              </li>
        ...
        <li class="nav-item">
          <span class="nav-link" v-b-toggle="'Categoria'">
            <span class="menu-title">Categorias</span>
            <i class="menu-arrow"></i>
            <i class="mdi mdi-crosshairs-gps menu-icon"></i>
          </span>
          <b-collapse accordion="sidebar-accordion" id="Categoria">
            <ul class="nav flex-column sub-menu">
              <li class="nav-item">
                <router-link class="nav-link" to="/categorias/registrar/">Crear</router-link>
              </li>
              <li class="nav-item">
                <router-link class="nav-link" to="/categorias/listar/">Listar</router-link>
              </li>
        ...
        <li class="nav-item">
          <span class="nav-link" v-b-toggle="'SubCategoria'">
            <span class="menu-title">SubCategorias</span>
            <i class="menu-arrow"></i>
            <i class="mdi mdi-crosshairs-gps menu-icon"></i>
          </span>
          <b-collapse accordion="sidebar-accordion" id="SubCategoria">
            <ul class="nav flex-column sub-menu">
              <li class="nav-item">
                <router-link class="nav-link" to="/subcategorias/registrar/">Crear</router-link>
              </li>
              <li class="nav-item">
                <router-link class="nav-link" to="/subcategorias/listar/">Listar</router-link>
              </li>
